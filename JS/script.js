...
for (let elem of users) {
    if (elem.email.includes('org') ) {
        emails.org.push(elem)
    }else if (elem.email.includes('net')) {
        emails.net.push(elem)
    }else if (elem.email.includes('info')) {
        emails.info.push(elem)
    }else {
        other.push(elem)
    }
}
